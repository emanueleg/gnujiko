...
/*
  ...
  Released under MIT License
*/
html2canvas.Renderer = function(parseQueue, opts, focalizeObject, _width, _height){


    var options = {
        "width": _width ? _width : null,
        "height": _height ? _height : null,
        "renderer": "canvas",
    ...
    function canvasRenderer(zStack){
		...
		if(options.elements)	// <-- changed at 19:09 2012-03-05 by alpatech 
         queueLen = options.elements.length;
		else
		 queueLen = 0;
        

		/* function added at 19:09 2012-03-05 by alpatech */
		if(focalizeObject)
		{
         bounds = html2canvas.Util.Bounds( focalizeObject );
