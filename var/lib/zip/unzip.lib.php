...
// 2003-12-02 - HB <
		...
		function GetSize($in_Index)	//--- insert by alpatech mediaware ---//
		{
		 	return $this->Entries[$in_Index]->Size;
		}
...
// 2003-12-02 - HB <
            ...
            foreach ($aE as $vZ) {
				...
				// func added by alpatech mediaware for zip size error //
				if (strlen($vZ) != $aP['CS'])
				 $vZ = substr($vZ, strlen($vZ) - $aP['CS']);

				$aI['S'] = $aP['CS']; //--- insert by alpatech mediaware for detect size of file ---//
...
// 2003-12-02 - HB <
                ...
                $aI['T'] = mktime(($aP['FT']  & 0xf800) >> 11,
                                  ...
                                  ($aP['FD']  & 0x001f),
                                  (($aP['FD'] & 0xfe00) >>  9) + 1980);
				$this->Entries[] = new SimpleUnzipEntry($aI); // Modificato da Alpatech il 14/11/2010 perchè il PHP 5 non accetta più l'operatore &new //
    ...
    class SimpleUnzipEntry {
         ...
         *  @since  1.0
         */
		 var $Size = 0; //--- insert by alpatech mediaware ---//
        ...
        function SimpleUnzipEntry($in_Entry)
        {
			...
			$this->Size		= $in_Entry['S']; //--- insert by alpatech mediaware ---//
