...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 #DESCRIPTION: New transfer form for Petty Cash Book.
 #VERSION: 2.0beta
 #CHANGELOG: 
 #TODO:
...
?>
<html><head><meta http-equiv="content-type" content="text/html; charset=UTF-8"><title>New Transfer</title>
<?php
...
$form = new GForm("Nuovo giroconto", "MB_OK|MB_ABORT", "simpleform", "default", "orange", 420, 260);
...
function OnFormSubmit()
{
 ...
 sh.sendCommand("dynarc new-item -ap `pettycashbook` -ctime `"+date+"` -name `"+description+"` -extset `pettycashbook.resin='"+resIn+"',resout='"+resOut+"',in='"+amount+"',out='"+amount+"'`");
}
