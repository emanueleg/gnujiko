...
$_STATUSEXTRA = array();
if($_COMMERCIALDOCS_CONFIG['STATUSEXTRA'] && $_COMMERCIALDOCS_CONFIG['STATUSEXTRA']['PREEMPTIVES'])
 $_STATUSEXTRA = $_COMMERCIALDOCS_CONFIG['STATUSEXTRA']['PREEMPTIVES'];
...
<tr><td colspan='3' style="border-left:1px solid #dedede;border-bottom:1px solid #dedede;border-right:1px solid #dedede;border-collapse:collapse;">
	...
	<tr><th width='32'><input type='checkbox' onchange="selectAllRows(this)" id="tbselectall"/></th>
		<?php
		$_COLUMNS = $_COMMERCIALDOCS_CONFIG['COLUMNS']['PREEMPTIVES'] ? $_COMMERCIALDOCS_CONFIG['COLUMNS']['PREEMPTIVES'] : array(
	 		0 => array("tag"=>"name", "title"=>"Preventivo", "width"=>190, "style"=>"text-align:left"),
