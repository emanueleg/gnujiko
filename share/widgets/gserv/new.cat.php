...
<link rel="stylesheet" href="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/new-cat.css" type="text/css" />
<?php
...
<div class="new-category-form">
 ...
 <ul class='basicbuttons' style="margin-left:4px;margin-top:2px;float:left;">
  <li><a href='#' onclick='submit()'><img src="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/img/save.gif" border='0'/>Salva e torna indietro</a></li>
  <li id='submitandenter'><a href='#' onclick='submit(true)'><img src="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/img/save.gif" border='0'/>Salva ed entra</a></li>
 </ul>

 <ul class='basicbuttons' style="float:right;margin-top:2px;margin-right:26px;">
  <li><a href='#' onclick="gframe_close()"><img src="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/img/exit.png" border='0'/>Annulla</a></li>
 </ul>
...
function submit(enter)
{
 ...
 for(var c=0; c < titles.length; c++)
  sh.sendCommand("dynarc new-cat -ap `<?php echo $_AP; ?>`"+(parentId ? " -parent `"+parentId+"`" : "")+" -name `"+titles[c]+"` -group gserv");
}
