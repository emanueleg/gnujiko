...
?>
<html><head><meta http-equiv="content-type" content="text/html; charset=UTF-8"><title>Item list</title>
...
{
 case 'smallthumb' : include($_BASE_PATH."share/widgets/gserv/smallthumb-view.php"); break;
 case 'list' : include($_BASE_PATH."share/widgets/gserv/list-view.php"); break;
 default : include($_BASE_PATH."share/widgets/gserv/thumbnails-view.php"); break;
}
?>
