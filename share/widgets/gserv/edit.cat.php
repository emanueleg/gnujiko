...
<tr><td colspan="3" valign="top" class="contents"><div class="contents">
	...
	<div class="page" id="page-thumbnail" style="display:none;">
	 ...
	 <table width='100%' border='0' class='thumbtable'>
	  ...
	  <tr><td align='center' valign='middle'><img src="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/img/no-thumbnail.png"/></td>
		  <td align='center' valign='middle'><img src="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/img/photo.png"/></td>
		  <td>
		   <?php
		   ...
		   <ul class='basicbuttons' style="clear:both;float:left;margin-top:5px;">
  			<li><span onclick="uploadImage()"><img src="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/img/add.gif" border='0'/>Carica...</span></li>
 		   </ul>
		  </td></tr>
	 </table>
	</div>
	...
	<div class="page" id="page-idocs" style="display:none;">
	 ...
	 <tr><td colspan='2'><h3 class='lightblue'>Schede interattive predefinite</h3></td>
		 <td align='right'><img src="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/img/add-btn-orange.png" class="add-idoc-btn" onclick="idocAdd()" title="Aggiungi"/></td></tr>
	 <?php
	 for($c=0; $c < count($catInfo['def_item_idocs']); $c++)
	 {
	  ...
	  if(!$ret['error'])
	  {
	   ...
	   echo "</td><td align='center' valign='middle'><img src='".$_ABSOLUTE_URL."share/widgets/gserv/img/red_delete.png' onclick='idocRemove(".$idoc['aid'].",".$idoc['id'].")' style='cursor:pointer;'/></td></tr>";
	  }
	 }
	 ?>
	 </table>
...
<tr><td class="footer-left" valign="top">
	 <ul class='basicbuttons' style="margin-left:15px;margin-top:4px;float:left;">
	  ...
	  <li><span onclick='deleteCategory()'><img src="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/img/delete.png" border='0'/>Elimina</span></li>
	 </ul>
	</td>
...
function uploadImage()
{
 ...
 sh.OnOutput = function(o,a){
	 ...
	 var dstPath = "image/gserv/categories/thumbnails/";
	 ...
	 //sh2.sendCommand("dynarc edit-cat -ap `gserv` -id `<?php echo $catInfo['id']; ?>` -extset `thumbnails.src='"+USER_HOME+dstFileName+"'`");
	}
...
function idocAdd()
{
 ...
 sh.OnOutput = function(o,a){
	 ...
	 sh2.OnOutput = function(){
		 ...
		 r.insertCell(-1).innerHTML = "<img src='"+ABSOLUTE_URL+"share/widgets/gserv/img/red_delete.png' onclick='idocRemove("+a['aid']+","+a['id']+")' style='cursor:pointer;'/ >";
		 r.cells[2].style.textAlign="center";
