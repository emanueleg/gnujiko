...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 #VERSION: 2.2beta
 #CHANGELOG: 04-02-2013 : Bug fix remove archive.
 #DEPENDS: guploader
...
<link rel="stylesheet" href="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/edit-catalog.css" type="text/css" />
<?php
	  ...
	  <tr><td width='50%' style="border-right:1px solid #cccccf;border-bottom:1px solid #cccccf;" valign="top">
			...
			<span class='tit'>Colore</span>&nbsp;<select id='theme-color'>
			 ...
			 while(list($k,$v) = each($options))
			  echo "<option value='".$k."'".($catInfo['params']['gserv-theme'] == $k ? " selected='selected'>" : ">").$v."</option>";
			 ?>
			</select>
			</div>
...
<tr><td class="footer-left" valign="top">
	 <ul class='basicbuttons' style="margin-left:15px;margin-top:4px;float:left;">
	  ...
	  <li><span onclick='deleteCatalog()'><img src="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/img/delete.png" border='0'/>Elimina</span></li>
	 </ul>
	</td>
...
function submit()
{
 ...
 var qry = "dynarc edit-archive -id `"+ARCHIVE_ID+"` -name `"+title+"` -params `gserv-theme="+themeColor+"`";
