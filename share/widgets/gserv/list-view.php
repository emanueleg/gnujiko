...
?>
<link rel="stylesheet" href="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/list-view.css" type="text/css" />
...
<tr><th width='40'><input type='checkbox' onchange='selectAll(this.checked,this)'/></th>
	<th width='180' class='sortasc'>SERVIZIO</th>
	<th>DESCRIZIONE</th>
...
$ret = GShell("dynarc item-list -ap `".$_AP."`".($_REQUEST['catid'] ? " -cat `".$_REQUEST['catid']."`" : "")." -extget `gserv,thumbnails,coding,pricing`".($_PLGET ? " -get `".$_PLGET."`" : "")." -limit ".($from ? $from : "0").",".$rpp." --return-serp-info",$_REQUEST['sessid'],$_REQUEST['shellid']);
...
for($c=0; $c < count($list); $c++)
{
 ...
 echo "<img src='".$_ABSOLUTE_URL.($item['thumbnails'][0] ? $item['thumbnails'][0] : "share/widgets/gserv/img/photo.png")."' width='32'/>";
...
function nextPage()
{
 ...
 html+= "<th width='180' class='sortasc'>SERVIZIO</th><th>DESCRIZIONE</th><th width='80' style='text-align:right;'>PREZZO</th><th width='30'>DISP.</th><th width='30'>ORD.</th></tr>";
 ...
 sh.OnOutput = function(o,a){
	 if(a && a['items'])
	 {
	  for(var c=0; c < a['items'].length; c++)
	  {
	   ...
	   html+= "<img src='"+ABSOLUTE_URL+(item['thumbnails'] ? item['thumbnails'][0] : "share/widgets/gserv/img/photo.png")+"' width='32'/ >";
	   ...
	   html+= "<td style='text-align:right;'><span class='green-block'>€. "+formatCurrency(finalPriceVI,DECIMALS)+"</span></td></tr>";
	  }
	 }
	 div.innerHTML = html;
