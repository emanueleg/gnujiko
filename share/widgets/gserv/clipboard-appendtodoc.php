...
<link rel="stylesheet" href="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/clipboard-appendtodoc.css" type="text/css" />
<?php
...
<tr><td class="footer-left" valign="top">
	...
	<td class="footer-right" colspan="2" valign="top">
	 <ul class='basicbuttons' style="float:right;margin-top:4px;margin-right:5px;">
	  <li><span onclick="showSummary()"><img src="<?php echo $_ABSOLUTE_URL; ?>share/widgets/gserv/img/summary.gif" border='0'/> Avanti</span></li>
	 </ul>
	&nbsp;
	</td></tr>
...
function showSummary()
{
 ...
 document.location.href=ABSOLUTE_URL+"share/widgets/gserv/clipboard-appendtodoc-summary.php?id=<?php echo $_REQUEST['id']; ?>&sessid=<?php echo $_REQUEST['sessid']; ?>&shellid=<?php echo $_REQUEST['shellid']; ?>&doctype="+DOC_TYPE+"&docid="+DOC_ID+(CUST_ID ? "&custid="+CUST_ID : "&custname="+CUST_NAME)+(includeCBTitle ? "&includecbtitle=true" : "");
}
