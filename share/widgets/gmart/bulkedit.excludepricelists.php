...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 #DATE: 28-09-2013
 #PACKAGE: gmart
 #DESCRIPTION: Bulk edit - exclude pricelists.
 #VERSION: 2.0beta
 #CHANGELOG: 
 #TODO:
...
?>
<html><head><meta http-equiv="content-type" content="text/html; charset=UTF-8"><title>BulkEdit - ExcludePricelists</title>
...
<div class='standardwidget' style='width:800px;'>
 <h2>Azioni di gruppo &raquo; escludi listini</h2>
 <hr/>
 ...
 <tr><td width="300" valign="top">
	 ...
	 <span class="smalltext">Seleziona i listini da escludere</span><br/><br/>
     <?php
...
function submit()
{
 ...
 sh.sendCommand("pricelists exclude -ap `<?php echo $_AP; ?>` -plids `"+pricelists.substr(1)+"` -cats `"+catIds.substr(1)+"`");
