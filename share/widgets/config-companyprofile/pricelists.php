...
{
 r.cells[3].innerHTML = "<a href='#' onclick='deleteRow2(this.parentNode.parentNode)'><img src='<?php echo $_ABSOLUTE_URL; ?>share/widgets/config-companyprofile/img/delete-small.png' border='0'/ ></a>";
}
...
function formSubmit(close)
{
 ...
 for(var c=1; c < tb.O.rows.length; c++)
 {
  ...
  if(r.id)
   ...
   cmd+= " && pricelists new";
  cmd+= " -name `"+r.cells[0].innerHTML+"` -markuprate `"+parseFloat(r.cells[1].innerHTML)+"` -vat `"+parseFloat(r.cells[2].innerHTML)+"`";
 }
