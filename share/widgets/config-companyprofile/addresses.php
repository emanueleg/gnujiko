...
<tr><td valign='top' class='left-block'>
	 ...
	 <?php echo i18n('Zip:'); ?> <input type='text' class='text' size='5' maxlength='5' id='regoff_zip' value="<?php echo $regoff['zip']; ?>"/> &nbsp; <?php echo i18n('Prov.:'); ?> <input type='text' class='text' size='2' maxlength='2' id='regoff_prov' value="<?php echo $regoff['prov']; ?>"/><br/>
...
<tr><td valign='top' class='left-block'>
	 ...
	 <?php echo i18n('Zip:'); ?> <input type='text' class='text' size='5' maxlength='5' id='hq_zip' value="<?php echo $hq['zip']; ?>"/> &nbsp; <?php echo i18n('Prov.:'); ?> <input type='text' class='text' size='2' maxlength='2' id='hq_prov' value="<?php echo $hq['prov']; ?>"/><br/>
...
<tr><td valign='top' class='left-block'>
	 ...
	 <?php echo i18n('Zip:'); ?> <input type='text' class='text' size='5' maxlength='5' id="otherloc_<?php echo $c; ?>_zip" value="<?php echo $OL[$c]['zip']; ?>"/> &nbsp; <?php echo i18n('Prov.:'); ?> <input type='text' class='text' size='2' maxlength='2' id="otherloc_<?php echo $c; ?>_prov" value="<?php echo $OL[$c]['prov']; ?>"/><br/>
...
function addNewLocation()
{
 ...
 r.insertCell(-1).innerHTML = "<div class='orangebar'><?php echo i18n('ADDRESS'); ?></div> <?php echo i18n('Address:'); ?> <input type='text' class='text' size='20' id='otherloc_"+idx+"_address' value=''/ ><br/ > <?php echo i18n('City:'); ?> <input type='text' class='text' size='20' id='otherloc_"+idx+"_city' value=''/ ><br/ > <?php echo i18n('Zip:'); ?> <input type='text' class='text' size='5' maxlength='5' id='otherloc_"+idx+"_zip' value=''/ > &nbsp; <?php echo i18n('Prov.:'); ?> <input type='text' class='text' size='2' maxlength='2' id='otherloc_"+idx+"_prov' value=''/ ><br/ > <?php echo i18n('Country:'); ?> <input type='text' class='text' size='2' maxlength='2' id='otherloc_"+idx+"_country' value=''/ ><br/ ><br/ >";
