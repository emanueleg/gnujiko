...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 #DATE: 02-01-2012
 #PACKAGE: apm-gui
 #DESCRIPTION: Add source form for APM
 #VERSION: 2.0beta
...
//-------------------------------------------------------------------------------------------------------------------//
?>
<html><head><meta http-equiv="content-type" content="text/html; charset=UTF-8"><title>APM - Add Source</title>
...
?></head><body><?php
$form = new GForm(i18n("Add source"), "MB_OK|MB_ABORT", "simpleform", "default", "blue", "380", "240");
$form->Begin($_ABSOLUTE_URL."share/widgets/apm/icons/settings.png");
?>
<p>URI: <input type="text" size="30" id="uri" value=""/></p>
<p><?php echo i18n("Version"); ?>: <input type="text" size="6" id="ver" value=""/></p>
<p><?php echo i18n("Section"); ?>: <input type="text" size="12" id="sec" value=""/></p>
...
function widget_submit()
{
 ...
 sh.sendCommand("apm add-repository -url `"+uri+"` -ver `"+ver+"` -sec `"+sec+"`");
 return false;
}
</script>
</body></html>
