...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 #DATE: 30-11-2012
 #PACKAGE: gstore
 #DESCRIPTION: Official Gnujiko store movements parser.
 #VERSION: 2.0beta
 #CHANGELOG:
 #TODO:
...
function gnujikocontentparser_storemovements_info($sessid, $shellid)
{
 $info = array('name' => "Movimenti di Magazzino");
 $keys = array(
	 "DATE_FROM" => "Dal", 
	 "DATE_TO" => "Al",
	 "SEARCH" => "Ricerca"
...
function gnujikocontentparser_storemovements_parse($_CONTENTS, $_PARAMS, $sessid, $shellid)
{
