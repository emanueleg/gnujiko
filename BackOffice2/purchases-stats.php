...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 #DATE: 27-08-2014
 #PACKAGE: backoffice2
 #DESCRIPTION: BackOffice 2 - Statistiche sugli acquisti
 #VERSION: 2.3beta
...
$template->Begin(i18n('Purchases stats'));
...
$centerContents = "<div class='titleblock' style='width:550px;float:left'>".i18n('Purchases stats')."</div>";
...
$ret = GShell("stats get -service purchases -from ".date('Y-m-d',$dateFrom)." -to ".date('Y-m-d',$dateTo)." -return '".$_REQUEST['rvf']."'");
...
<div class="totals-footer">
 <div class="title"><?php echo i18n('Total'); ?> <?php echo ($_REQUEST['rvf'] == "qty") ? i18n("of quantity purchases") : i18n('purchase'); ?> 
...
<div class="panel" style="margin:3px">
 <div class="title"><?php echo i18n('Summary purchases')." ".i18n('from')." ".date('d/m/Y',$dateFrom)." ".i18n('to')." ".date('d/m/Y',$dateTo); ?></div>
